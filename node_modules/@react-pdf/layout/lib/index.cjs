...
var isText$5 = isType$3(P__namespace.Text);
  ...
  var _ref = _asyncToGenerator__default.default( /*#__PURE__*/_regeneratorRuntime__default.default().mark(function _callee() {
    ...
    return _regeneratorRuntime__default.default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Yoga__namespace.loadYoga();
        case 2:
...
var resolveYoga = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator__default.default( /*#__PURE__*/_regeneratorRuntime__default.default().mark(function _callee(root) {
    var yoga;
    return _regeneratorRuntime__default.default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var getPadding = function getPadding(node) {
  var style = node.style,
    box = node.box;
  var paddingTop = getComputedPadding(node, Yoga__namespace.Edge.Top) || (box === null || box === void 0 ? void 0 : box.paddingTop) || (style === null || style === void 0 ? void 0 : style.paddingTop) || (style === null || style === void 0 ? void 0 : style.paddingVertical) || (style === null || style === void 0 ? void 0 : style.padding) || 0;
  var paddingRight = getComputedPadding(node, Yoga__namespace.Edge.Right) || (box === null || box === void 0 ? void 0 : box.paddingRight) || (style === null || style === void 0 ? void 0 : style.paddingRight) || (style === null || style === void 0 ? void 0 : style.paddingHorizontal) || (style === null || style === void 0 ? void 0 : style.padding) || 0;
  var paddingBottom = getComputedPadding(node, Yoga__namespace.Edge.Bottom) || (box === null || box === void 0 ? void 0 : box.paddingBottom) || (style === null || style === void 0 ? void 0 : style.paddingBottom) || (style === null || style === void 0 ? void 0 : style.paddingVertical) || (style === null || style === void 0 ? void 0 : style.padding) || 0;
  var paddingLeft = getComputedPadding(node, Yoga__namespace.Edge.Left) || (box === null || box === void 0 ? void 0 : box.paddingLeft) || (style === null || style === void 0 ? void 0 : style.paddingLeft) || (style === null || style === void 0 ? void 0 : style.paddingHorizontal) || (style === null || style === void 0 ? void 0 : style.padding) || 0;
  return {
...
var isText$4 = isType$2(P__namespace.Text);
...
var resolveInheritance = function resolveInheritance(node) {
  ...
  var inheritStyles = fns.pick(inheritableProperties, node.style || {});
...
var getMargin = function getMargin(node) {
  var style = node.style,
    box = node.box;
  var marginTop = getComputedMargin(node, Yoga__namespace.Edge.Top) || (box === null || box === void 0 ? void 0 : box.marginTop) || (style === null || style === void 0 ? void 0 : style.marginTop) || (style === null || style === void 0 ? void 0 : style.marginVertical) || (style === null || style === void 0 ? void 0 : style.margin) || 0;
  var marginRight = getComputedMargin(node, Yoga__namespace.Edge.Right) || (box === null || box === void 0 ? void 0 : box.marginRight) || (style === null || style === void 0 ? void 0 : style.marginRight) || (style === null || style === void 0 ? void 0 : style.marginHorizontal) || (style === null || style === void 0 ? void 0 : style.margin) || 0;
  var marginBottom = getComputedMargin(node, Yoga__namespace.Edge.Bottom) || (box === null || box === void 0 ? void 0 : box.marginBottom) || (style === null || style === void 0 ? void 0 : style.marginBottom) || (style === null || style === void 0 ? void 0 : style.marginVertical) || (style === null || style === void 0 ? void 0 : style.margin) || 0;
  var marginLeft = getComputedMargin(node, Yoga__namespace.Edge.Left) || (box === null || box === void 0 ? void 0 : box.marginLeft) || (style === null || style === void 0 ? void 0 : style.marginLeft) || (style === null || style === void 0 ? void 0 : style.marginHorizontal) || (style === null || style === void 0 ? void 0 : style.margin) || 0;
  return {
    marginTop: marginTop,
...
var setOverflow = function setOverflow(value) {
  return function (node) {
    ...
    if (!fns.isNil(value) && yogaNode) {
      var overflow = OVERFLOW[value] || Yoga__namespace.Overflow.Visible;
...
var setFlexWrap = function setFlexWrap(value) {
  return function (node) {
    var yogaNode = node.yogaNode;
    if (yogaNode) {
      var flexWrap = FLEX_WRAP[value] || Yoga__namespace.Wrap.NoWrap;
...
var setAlign = function setAlign(attr) {
  return function (value) {
    return function (node) {
      var yogaNode = node.yogaNode;
      var defaultValue = attr === 'items' ? Yoga__namespace.Align.Stretch : Yoga__namespace.Align.Auto;
      if (yogaNode) {
...
var setFlexDirection = function setFlexDirection(value) {
  return function (node) {
    var yogaNode = node.yogaNode;
    if (yogaNode) {
      var flexDirection = FLEX_DIRECTIONS[value] || Yoga__namespace.FlexDirection.Column;
...
var setJustifyContent = function setJustifyContent(value) {
  return function (node) {
    var yogaNode = node.yogaNode;
    if (!fns.isNil(value) && yogaNode) {
      var justifyContent = JUSTIFY_CONTENT[value] || Yoga__namespace.Justify.FlexStart;
 ...
 * @returns {Object} node instance
 */
var setMarginTop = setYogaValue('margin', Yoga__namespace.Edge.Top);
 ...
 * @returns {Object} node instance
 */
var setMarginRight = setYogaValue('margin', Yoga__namespace.Edge.Right);
 ...
 * @returns {Object} node instance
 */
var setMarginBottom = setYogaValue('margin', Yoga__namespace.Edge.Bottom);
 ...
 * @returns {Object} node instance
 */
var setMarginLeft = setYogaValue('margin', Yoga__namespace.Edge.Left);
 ...
 * @returns {Object} node instance
 */
var setPaddingTop = setYogaValue('padding', Yoga__namespace.Edge.Top);
 ...
 * @returns {Object} node instance
 */
var setPaddingRight = setYogaValue('padding', Yoga__namespace.Edge.Right);
 ...
 * @returns {Object} node instance
 */
var setPaddingBottom = setYogaValue('padding', Yoga__namespace.Edge.Bottom);
 ...
 * @returns {Object} node instance
 */
var setPaddingLeft = setYogaValue('padding', Yoga__namespace.Edge.Left);
 ...
 * @returns {Object} node instance
 */
var setBorderTop = setYogaValue('border', Yoga__namespace.Edge.Top);
 ...
 * @returns {Object} node instance
 */
var setBorderRight = setYogaValue('border', Yoga__namespace.Edge.Right);
 ...
 * @returns {Object} node instance
 */
var setBorderBottom = setYogaValue('border', Yoga__namespace.Edge.Bottom);
 ...
 * @returns {Object} node instance
 */
var setBorderLeft = setYogaValue('border', Yoga__namespace.Edge.Left);
 ...
 * @returns {Object} node instance
 */
var setPositionTop = setYogaValue('position', Yoga__namespace.Edge.Top);
 ...
 * @returns {Object} node instance
 */
var setPositionRight = setYogaValue('position', Yoga__namespace.Edge.Right);
 ...
 * @returns {Object} node instance
 */
var setPositionBottom = setYogaValue('position', Yoga__namespace.Edge.Bottom);
 ...
 * @returns {Object} node instance
 */
var setPositionLeft = setYogaValue('position', Yoga__namespace.Edge.Left);
...
var createYogaNodes = function createYogaNodes(page, fontStore, yoga) {
  return function (node) {
    ...
    if (isLayoutElement(node) && node.children) {
      var resolveChild = fns.compose(insertYogaNodes(yogaNode), createYogaNodes(page, fontStore, yoga));
...
var relayoutPage = fns.compose(resolveTextLayout, resolvePageDimensions, resolveInheritance, resolvePageStyles);
...
var layout = fns.asyncCompose(resolveZIndex, resolveOrigin, resolveAssets, resolvePagination, resolveTextLayout, resolvePercentRadius, resolveDimensions, resolveSvg, resolveAssets, resolveInheritance, resolvePercentHeight, resolvePagesPaddings, resolveStyles, resolveLinkSubstitution, resolveBookmarks, resolvePageSizes, resolveYoga);
